    ...
    <div className="glass grid-glow rounded-3xl p-6">
      ...
      <div className="mt-6">
        <StatusHistogramChart 
          ...
          onResetZoom={onHistogramResetZoom}
        />
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-3 space-y-3">
          ...
          {ranges.map(range => {
            ...
            if (weeks > 0) durationParts.push(`${weeks} שבועות`);
            if (days > 0) durationParts.push(`${days} ימים`);
            if (hours > 0) durationParts.push(`${hours} שעות`);
            if (minutes > 0) durationParts.push(`${minutes} דקות`);
